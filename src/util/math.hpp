...
template <>
inline std::uint8_t rotl_fixed<std::uint8_t>(std::uint8_t x, unsigned int y) {
	return y ? _rotl8(x, y) : x;
}

template <>
inline std::uint16_t rotl_fixed<std::uint16_t>(std::uint16_t x, unsigned int y) {
...
#ifdef _MSC_VER
template <>
inline std::uint32_t rotl_fixed<std::uint32_t>(std::uint32_t x, unsigned int y) {
...
template <>
inline std::uint64_t rotl_fixed<std::uint64_t>(std::uint64_t x, unsigned int y) {
